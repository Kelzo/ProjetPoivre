 ...
 */
class PoivreUserBundleEntityUserProxy extends \Poivre\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNumeroFixe($numero_fixe);
    }

    public function getNumeroFixe()
    {
        $this->__load();
        return parent::getNumeroFixe();
    }

    public function setNumeroPortable($numero_portable)
    {
        $this->__load();
        return parent::setNumeroPortable($numero_portable);
    }

    public function getNumeroPortable()
    {
        $this->__load();
        return parent::getNumeroPortable();
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'nom', 'prenom', 'genre', 'age', 'adresse', 'cp', 'ville', 'numero_fixe', 'numero_portable', 'statut');
    }
