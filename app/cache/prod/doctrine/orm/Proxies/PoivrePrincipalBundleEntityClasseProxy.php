 ...
 */
class PoivrePrincipalBundleEntityClasseProxy extends \Poivre\PrincipalBundle\Entity\Classe implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'intitule', 'annee', 'niveau', 'responsable');
    }
